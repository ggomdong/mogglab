    ...
    <section className="py-24 px-6 lg:px-8 bg-white">
      <div className="max-w-4xl mx-auto">
        <div className="relative">
          {/* Gradient background */}
          <div className="absolute inset-0 bg-gradient-to-br from-blue-600 via-blue-600 to-pink-600 rounded-3xl"></div>
          ...
          <div className="relative px-8 py-16 md:px-16 md:py-20 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-10">
              <a
                ...
                className="px-8 py-4 font-semibold bg-white text-blue-600 rounded-xl hover:bg-blue-50 transition-all hover:shadow-xl flex items-center justify-center gap-2"
              >
                데모/도입 문의
